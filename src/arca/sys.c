...
void arca_nop(void) { syscall(__NR_nop); }

arcad arca_clone(arcad value) { return syscall(__NR_clone, value); }

int64_t arca_drop(arcad value) { return syscall(__NR_drop, value); }
...
int64_t arca_type(arcad value) { return syscall(__NR_type, value); }

arcad arca_null_create(void) { return syscall(__NR_create_null); }
...
arcad arca_tuple_create(size_t len) { return syscall(__NR_create_tree, len); }

arcad arca_page_create(size_t size) { return syscall(__NR_create_page, size); }

arcad arca_table_create(size_t size) { return syscall(__NR_create_table, size); }
...
arcad arca_exception_read(arcad error) { return syscall(__NR_read, error); }
...
int64_t arca_equals(arcad x, arcad y) { return syscall(__NR_equals, x, y); }
...
int64_t arca_exception_reset(void) { return syscall(__NR_error_reset); }
